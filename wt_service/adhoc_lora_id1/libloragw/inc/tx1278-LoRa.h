#ifndef __TX1278_LORA_H__
#define __TX1278_LORA_H__
...
//LoRa的返回值 表示当前的模块工作状态
typedef enum
{
	TXLORA_STATE_IDLE,
	TXLORA_STATE_RX_INIT,
	TXLORA_STATE_RX_RUNNING,
	TXLORA_STATE_RX_DONE,
	TXLORA_STATE_RX_IDLE,
	TXLORA_STATE_RX_TIMEOUT,
	TXLORA_STATE_TX_INIT,
	TXLORA_STATE_TX_RUNNING,
	TXLORA_STATE_TX_DONE,
	TXLORA_STATE_TX_IDLE,
	TXLORA_STATE_TX_TIMEOUT,
	TXLORA_STATE_CAD_INIT,
	TXLORA_STATE_CAD_RUNNING,
	TXLORA_STATE_TX_START,
}tTXLORAStates;
...
//启用/禁用LoRa模式
void TX1278LoRaSetLoRaOn( bool enable );
...
uint8_t TX1278GetLoRaLNA(void);

void TX1278TxData(uint8_t * buff, uint8_t size);			//发送
