...
//#define SPI_1278_DEV_PATH   "/dev/spidev0.0"
#define SPI_DEV_PATH        "/dev/spidev2.0"
#define SPI_1278_DEV_PATH   "/dev/spidev1.0"
...
int lgw_spi_open(void **spi_target_ptr, uint32_t decive) {
    int *spi_device = NULL;
    int dev;
    int a=0, b=0;
    int i;
    ...
    if(0x1278==decive)
    {
        dev = open(SPI_1278_DEV_PATH, O_RDWR);
    }
    else
    {
